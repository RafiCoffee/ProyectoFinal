...
import com.example.proyectofinal.databinding.FragmentTareasDiariasBinding
import com.example.proyectofinal.ui.modelView.FragmentViewModel
import java.util.Calendar

class TareasDiarias constructor() : Fragment() {
    private lateinit var listener: TareasListener

    lateinit var tareasBinding: FragmentTareasDiariasBinding
    ...
    override fun onCreateView(
        ...
        tareasBinding = FragmentTareasDiariasBinding.inflate(inflater, container, false)
