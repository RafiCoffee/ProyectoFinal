...
class TareasDiarias : Fragment() {
    val hoy = Calendar.getInstance()

    private lateinit var tareasDiariasAdapter: ArrayAdapter<Tarea>
    private var tareasDiariasList = ArrayList<Tarea>()

    private lateinit var listatareasDiarias: ListView
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_tareas_diarias, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        listatareasDiarias = view.findViewById(R.id.listaTareas)
        annadirElementoBt = view.findViewById(R.id.annadirElementoBt)

        tareasDiariasAdapter = TareasListAdapter(requireContext(), tareasDiariasList)
        listatareasDiarias.adapter = tareasDiariasAdapter
    ...
    private fun mostrarAnnadirTarea(){
        ...
        builder.setPositiveButton("Aceptar"){ _, _ ->
            ...
            tareasDiariasList.add(nuevaTarea)
            tareasDiariasAdapter.notifyDataSetChanged()
        }
