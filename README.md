...
![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.001.png)
...
![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.012.png)
...
Mi ***Clean  Arquitecture***  esta  formada  por  3  carpetas  principales, *application*, *data*, y *ui*.

![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.013.png)
...
![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.014.png)

En está carpeta básicamente contenemos todas las clases que tengan algo que ver con el manejo de datos, ya sean callbacks, interfaces, servicios… También podemos ver los modelos y  repositorios  los  cuales  usaremos  para comunicarnos  correctamente  con  nuestros respectivos *ViewModels*.

![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.015.png)

En cuanto a la carpeta de *ui*  podemos ver, como su nombre indica, todo lo relacionado con  la  interfaz  de  usuario.  Adaptadores,  dialogos,  views…  Esta  última  subcarpeta  contiene todas nuestras *activities* y *fragments*.  

Podemos  ver  la  carpeta *modelView*,  que  contiene los *ViewModels*, hablemos de ellos.

![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.016.png)

Podemos  ver  varios *ViewModels*  en  la carpeta, los  cuales  he  utilizado  para sincronizar los datos con la UI a excepción de *FragmentViewModel*  el  cual  he utilizado para otra tarea la cual explicare en [***7- Problemas Durante El Desarrollo***](#_page29_x56.70_y81.60).
...
![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.017.png)

![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.018.png)
...
![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.019.png)
...
![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.020.png)
...
![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.021.png)
...
![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.022.png)

![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.023.png)
...
![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.027.png)
...
![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.028.png)

Tras  haber  hecho  la  referencia,  creamos  o  editamos  la  tarea correspondiente y la añadimos a nuestra base de datos con todos sus atributos. Este proceso para conectarme con Firebase es practicamente el mismo cada vez que quiero recuperar, subir o editar datos de esta plataforma, hacer referencia a la herramienta necesaria, especificar el lugar de acción y por ultimo especificar y ejecutar la acción en sí.

Me gustaría destacar esta pequeña *SplashScreen*  que  se  encarga  de  cargar los datos en segundo plano  mientras el usuario ve esta pantalla  de carga sencilla. Para sincronizar  la barra de progreso con los datos  simplemente hago que avance poco  a poco hasta un punto en concreto  en el que se detiene hasta que los  datos  se  han  cargado  en  mi  aplicación  completamente,  es  en  ese momento que el progreso se  termina de completarse  rápidamente  dejando  entrar  al  usuario a la app en sí.

**SplashActivity**

![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.029.png)

![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.030.jpeg)
...
![](images/Aspose.Words.4a3f7558-bca9-47a1-b0e5-97ecba008f11.032.png)
